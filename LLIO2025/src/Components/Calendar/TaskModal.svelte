    ...
    <div class="modal" on:click|stopPropagation>
      ...
      <form on:submit|preventDefault={handleSubmit}>
        ...
        <div class="form-group">
          ...
          <textarea id="task-description" bind:value={task.description} rows="3"></textarea>
        </div>

        <div class="form-row">
          <div class="form-group">
            <label for="task-state">État*</label>
            <select id="task-state" bind:value={task.state} required>
          ...
          <div class="form-group checkbox">
            <label>
              <input type="checkbox" bind:checked={task.billable} />
              Facturable
            </label>
          </div>
        </div>
        ...
        <div class="form-group time-inputs">
          ...
          <div class="time-select">
            ...
            <div class="time-pickers">
              <select bind:value={time.endHours} on:change={validateEndTime}>
                {#each hours as hour}
                  <option value={hour}>{hour}h</option>
                {/each}
              </select>
              <select bind:value={time.endMinutes} on:change={validateEndTime}>
                {#each minutes as minute}
                  <option value={minute}>{minute}</option>
                {/each}
              </select>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select id="task-user" bind:value={task.userId} required>
          ...
          <div class="form-group">
            ...
            <select id="task-project" bind:value={task.projectId} required>
              <option value="">Sélectionner...</option>
          ...
          <div class="form-group">
            ...
            <select id="task-category" bind:value={task.categoryId} required>
              <option value="">Sélectionner...</option>
        ...
        <div class="button-group">
          {#if editMode}
            <button type="button" class="btn-danger" on:click={handleDelete}> Supprimer </button>
